...
if(isset($_POST['submit']))
 ...
 $sql="UPDATE class1 SET sub5=99  WHERE id=18";
...
<input type="text" name="name" placeholder="Enter your name" max=500 required>
...
<label>Science:</label>
<input type="text" name="sub4" max=100  placeholder="Enter value of sub4" value="<?php  echo $sci;   ?>" required><br><br>
<label>History:</label>
<input type="text" name="sub5" max=100 placeholder="Enter value of sub5" value="<?php  echo $his;   ?>" required><br><br>
